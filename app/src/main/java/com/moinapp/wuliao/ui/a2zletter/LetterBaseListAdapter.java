...
{
    /** log tag. **/
    private static final ILogger MyLog = LoggerFactory.getLogger("lbla");
    ...
    private char getHeaderLetter(T t)
    {
        ...
        {
            MyLog.e("item string empty in " + t.toString());
            return ERROR_LETTER;
        }
        char l;
        //获取第一个字母
        ...
        else
        {
            ...
            {
                //如果汉字转拼音失败了,跳过
                MyLog.e(firstChar + " turn to letter fail, " + t.toString());
                return ERROR_LETTER;
            }
        }

...
import com.moinapp.wuliao.modules.stickercamera.app.camera.util.UIUtils;
import com.moinapp.wuliao.ui.drawable.EditableDrawable;
import com.moinapp.wuliao.ui.drawable.FeatherDrawable;
...
//    private ImageViewTouch        mContext;
    ...
    public void setScaleable(boolean scaleable) {
        ...
        if (scaleable) {
            mAnchorRotate = AppContext.getApp().getResources().getDrawable(R.drawable.aviary_resize_knob);
        } else {
            mAnchorRotate = null;
        }
    }
    ...
    public void setDeleteable(boolean deleteable) {
        if (deleteable) {
            mAnchorDelete = AppContext.getApp().getResources().getDrawable(R.drawable.aviary_delete_knob);
        } else {
            mAnchorDelete = null;
        }
    }
    ...
    public void draw(final Canvas canvas) {
        ...
        if (is_selected || is_focused) {
            ...
            if (mShowAnchors) {
                ...
                outlinePaint.setStrokeWidth(AppContext.getApp().dp2px(1));

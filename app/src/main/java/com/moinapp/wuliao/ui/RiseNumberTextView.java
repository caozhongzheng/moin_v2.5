...
import com.moinapp.wuliao.listener.IRiseNumber;
import com.nineoldandroids.animation.ValueAnimator;

import java.text.DecimalFormat;

/**
 * Created by liujiancheng on 16/7/27.
 */
...
//      setTextSize(30);
     ...
     */
    @Override
    public void withNumber(int number, int startNumber) {
        this.number = number;
        numberType = 1;
        if (startNumber >= 0 && startNumber <= number) {

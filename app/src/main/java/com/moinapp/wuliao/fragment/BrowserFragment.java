...
public class BrowserFragment extends BaseFragment {
    ...
    public static final String DEFAULT = "http://www.moinapp.com/";
    ...
    public void onResume() {
        super.onResume();
        MobclickAgent.onPageStart(UmengConstants.BROWSER_FRAGMENT); //统计页面
        mWebView.onResume();
    }
    ...
    public void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd(UmengConstants.BROWSER_FRAGMENT);
        mWebView.onPause();
    }
    ...
    private void showSharedDialog() {
        ...
        dialog.setShareInfo(getShareTitle(), getShareContent(), null, mCurrentUrl);
        dialog.show();
    }

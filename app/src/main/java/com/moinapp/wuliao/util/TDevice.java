...
public class TDevice {
    ...
    private static ILogger MyLog = LoggerFactory.getLogger(TDevice.class.getSimpleName());
    // 手机网络类型
    ...
    public static String getIMSI() {
        TelephonyManager mTelephonyMgr = (TelephonyManager) BaseApplication.context()
                .getSystemService(Context.TELEPHONY_SERVICE);

...
//            return;
    ...
    public void playTo(int position) {
        ...
        if (position >= mImageViews.size()) return;
    ...
    public void playBy(int startPosition,int nextPosition){
        ...
        if (nextPosition >= mImageViews.size()) {
            nextPosition = mImageViews.size() - 1;
        }
